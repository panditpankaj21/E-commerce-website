    ...
    <section className="xl:w-[55rem] lg:w-[55rem] sm:w-[40rem] xs:w-[20rem] p-5">
        <div className="mb-5">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mt-5">
                <button 
                    className={`border px-4 py-2 mx-2 rounded-full hover:bg-gray-200 ${currentPage===1 ? "cursor-not-allowed" : "cursor-pointer"}`}
                ...
                <button 
                    className={`border px-4 py-2 mx-2 rounded-full hover:bg-gray-200 ${currentPage=== totalPages ? "cursor-not-allowed" : "cursor-pointer"}`}
                    onClick={() => handlePageChange(currentPage+1)}
